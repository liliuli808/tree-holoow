...
import { Heart, MessageCircle, Share2, MoreHorizontal, Play, Pause, Mic, Image as ImageIcon, Video, X, Send } from 'lucide-react';
...
const MediaViewer = ({ url, type, onClose }: { url: string; type: 'image' | 'video'; onClose: () => void }) => {
  return (
